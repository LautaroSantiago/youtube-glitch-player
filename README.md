...
Las contribuciones, reportes de bugs y sugerencias son bienvenidas. Por favor:

1. Abre un issue describiendo el problema o idea
2. Si envías código, asegúrate de seguir el estilo del proyecto
...
- [ ] Integración con Spotify (lectura de playlists)
- [ ] Soporte para descargar audio (según disponibilidad)
...
Este reproductor utiliza la YouTube IFrame Player API. Los videos reproducidos están sujetos a los Términos de Servicio de YouTube. No se puede descargar contenido protegido sin consentimiento del propietario.
